	...
	var validate = $("#signupForm").validate({
		...
		messages: {
            username: {
                ...
                minlength: jQuery.format($.i18n.prop("用户名长度不能少于4")),
                maxlength: jQuery.format($.i18n.prop("用户名最大长度不能多于16"))
			},
			password: {
				required: $.i18n.prop("请输入密码"),
				minlength: jQuery.format($.i18n.prop("密码长度不能少于4")),
				maxlength: jQuery.format($.i18n.prop("密码最大长度不能多于16"))
			},
			passwordAgain: {
